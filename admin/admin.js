...
const REPO_NAME = 'postatusaugust';
...
els.addForm.addEventListener('submit', async (e) => {
  ...
  const contact = els.newContact.value.trim();
  ...
  try {
    ...
    // roll back the local push since the commit failed
    STATE.orders = STATE.orders.filter(o => o !== newOrder);
